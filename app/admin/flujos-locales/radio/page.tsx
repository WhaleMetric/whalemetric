...
import TvChannelsClient, { type Channel } from '../tv/_components/TvChannelsClient';
...
export default async function RadioPage() {
  const channels = await fetchChannels('radio');
  return <TvChannelsClient initialChannels={channels} kind="radio" />;
}
